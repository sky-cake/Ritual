...
# if False, the first loop fetches fresh api data (ignores the last-modified-at header)
# Later loops always use the cache.
# Good for finding more posts marked as deleted on 4chan
use_http_cache_first_loop = True


# will fetch any media reported missing by the database
# Good for resuming from an archiving pause/interruption.
...
#   This is the standard in the archiving community, but it does not avoid duplicate files
## Sutra ##
#   Saves media to filepaths like,
...
#   If you want to use Sutra, and were already using Asagi,
...
db_sqlite_path = 'path/to/ritual.db'
...
logger_name = 'ritual'
log_stdout = True
log_file = False # or 'ritual.log' if you want to log to files
log_filesize = 5 * 1024 * 1024
log_max_files = 3
